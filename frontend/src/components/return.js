...
class Return extends Component {
  constructor(props){
    ...
    this.state = {
      ...
      book: 0,
      time: '',
      lender: '0xe36f0158f0aed45b3bc755dc52ed4560d	',
    }
  ...
  handleSubmit(event) {
    event.preventDefault();
      ...
      axios.post(postEndpoint, { "lender": this.state.borrower,
      "borrower": this.state.lender,
  ...
  render(){
    return (
        <Container>
  <br/>
  <h4><b style={{color: '#007bff'}}>Return borrowed books</b> </h4>
